...
const STRINGS = {
  en: {
    ...
    settings_voice_natural: 'Natural human voice',
    settings_voice_natural_sub: 'Off: play with the device voice (instant, no synthesis).',
    ...
    paywall_monthly_price_fallback: '¥480',
    paywall_yearly_price_fallback: '¥3,800',
    paywall_trial_badge: 'Includes a {duration} free trial',
    paywall_trial_badge_generic: 'Includes a free trial',
    paywall_yearly_badge: 'Save 33%',
    paywall_continue: 'Continue',
    paywall_per_month: '/ month · auto-renews',
    paywall_per_year: '/ year · auto-renews',
    paywall_period_day: '{n}-day',
    paywall_period_week: '{n}-week',
    paywall_period_month: '{n}-month',
    paywall_period_year: '{n}-year',
    paywall_start: 'Start subscription',
    paywall_start_trial: 'Start free trial',
    paywall_trial_terms: 'After the free trial ends, the subscription auto-renews. Cancel at least 24 hours before it ends to avoid charges.',
    paywall_renew_terms: 'Auto-renews until canceled. Cancel anytime.',
  ...
  ja: {
    ...
    settings_voice: '音声',
    settings_voice_natural: '自然な人間の声',
    settings_voice_natural_sub: 'オフにすると端末の声で再生（生成なし・すぐ再生）。',
    ...
    paywall_monthly_price_fallback: '¥480',
    paywall_yearly_price_fallback: '¥3,800',
    paywall_trial_badge: '{duration}の無料トライアル付き',
    paywall_trial_badge_generic: '無料トライアル付き',
    paywall_yearly_badge: '33% OFF',
    paywall_continue: '続ける',
    paywall_per_month: '/月 ・ 自動更新',
    paywall_per_year: '/年 ・ 自動更新',
    paywall_period_day: '{n}日間',
    paywall_period_week: '{n}週間',
    paywall_period_month: '{n}か月',
    paywall_period_year: '{n}年間',
    paywall_start: 'サブスクリプションを開始',
    paywall_start_trial: '無料トライアルを開始',
    paywall_trial_terms: '無料トライアル終了後に自動更新されます。終了の24時間前までに解約すれば料金はかかりません。',
    paywall_renew_terms: '解約するまで自動更新されます。いつでも解約できます。',

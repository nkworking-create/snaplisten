...
const STRINGS = {
  en: {
    ...
    paywall_trial_badge: 'Includes 7-day free trial',
    ...
    paywall_trial_terms: 'Includes a 7-day free trial. Cancel at least 24 hours before it ends to avoid charges.',
  ...
  ja: {
    ...
    paywall_monthly_price_fallback: '¥480',
    paywall_yearly_price_fallback: '¥3,800',
    paywall_trial_badge: '7日間の無料トライアル付き',
    ...
    paywall_trial_terms: '7日間の無料トライアル付き。終了の24時間前までに解約すれば料金はかかりません。',
